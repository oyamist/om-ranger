...
enum DisplayStatus {
    ...
    // Ignoring input
    DISPLAY_BUSY = 30, // TinyThreads is busy but not moving
    DISPLAY_BUSY_MOVING = 31, // TinyThreads is busy and moving
    DISPLAY_BUSY_CALIBRATING = 32, // TinyThreads is busy and calibrating
